...
# 一個list裡面有blue_bottle, mug...
result_list = ['blue_bottle', 'mug', 'small_mug', 'long_box', 'tap', 'wash_hand']

for result in result_list:
    multiview_path = os.path.join(parent_directory, f'my_test_data/{result}.npy')
    ...
    # 將plane_model[:3]和second_principal_axis變成一個transform matrix
